...
Before writing any test scenario, understand the primary purpose of the chart. Take a look at [the documentation about the chart under test](https://github.com/pindarolidev/helm/tree/master/pindarolidev) as well as the [docker image documentation](https://github.com/pindarolidev?q=docker&type=all&language=&sort=). This will give you a solid base for creating valuable test scenarios.
